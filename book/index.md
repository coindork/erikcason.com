  ...
  <div class="cs-wrap">
    ...
    <section class="cs-grid">
      <div class="cs-mini">
        <h3>What it is</h3>
        <p>
          A philosophy of Bitcoin as an emergent political order grounded in property,
          cryptography, and non-violent coordination.
        </p>
      </div>
...
.cs-quotes{margin-top:26px;display:grid;gap:18px}
